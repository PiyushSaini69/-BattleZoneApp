    ...
    >
      <View className="flex-row justify-between items-center mb-6 mt-4">
        ...
        <Pressable 
          ...
          className="w-12 h-12 bg-slate-900 rounded-full border border-purple-500/30 justify-center items-center overflow-hidden"
        >
      ...
      <GlassCard className="p-5 items-center bg-purple-900/10 border-purple-500/20 mt-2 mb-6">
        ...
        <Pressable 
          ...
          className="bg-[#7C3AED] px-6 py-3.5 rounded-xl border border-purple-500 shadow-md shadow-purple-600/30 w-full"
        >
