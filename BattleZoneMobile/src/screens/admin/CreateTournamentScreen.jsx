              ...
              {[
                ...
                <Pressable
                  ...
                  className={`px-3 py-2 rounded-lg border mb-2 w-[48%] items-center ${
                    game === g.value ? 'bg-[#7C3AED]/20 border-purple-500' : 'bg-slate-900 border-slate-800'
                  }`}
                >
              ...
              {['solo', 'duo', 'squad'].map((t) => (
                <Pressable
                  ...
                  className={`flex-1 mx-1 py-2 rounded-lg border items-center ${
                    tournamentType === t ? 'bg-[#7C3AED]/20 border-purple-500' : 'bg-slate-900 border-slate-800'
                  }`}
                >
