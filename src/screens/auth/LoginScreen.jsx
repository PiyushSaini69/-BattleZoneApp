  ...
  return (
    <ScrollView className="flex-1 bg-[#0B0F1A]" contentContainerStyle={{ flexGrow: 1, justifyContent: 'center', padding: 20 }}>
      ...
      <GlassCard className="mb-6">
        <Text className="text-white text-lg font-bold mb-6 text-center uppercase tracking-wider">Welcome Warrior</Text>
        ...
        >
          <Text className="text-purple-400 font-semibold text-xs">Forgot Password?</Text>
        </Pressable>
